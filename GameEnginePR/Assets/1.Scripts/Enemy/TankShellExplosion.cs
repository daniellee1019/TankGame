...
namespace Complete
{
    public class TankShellExplosion : MonoBehaviour
    {
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            Collider[] colliders = Physics.OverlapSphere(transform.position, m_ExplosionRadius, 1 << 12);
            ...
            for (int i = 0; i < colliders.Length; i++)
            {
                ...
                EnemyHealthControll targetHealth = targetRigidbody.GetComponent<EnemyHealthControll>();
